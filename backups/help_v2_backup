...
# Objectif : Affiche la liste des commandes ou les infos sur une commande spécifique
# Catégorie : 🧠 Général
# Accès : Public
# ────────────────────────────────────────────────────────────────────────────────
...
class HelpCommand(commands.Cog):
    """
    Commande !help — Affiche la liste des commandes ou les infos sur une commande spécifique.
    """
