...
# ──────────────────────────────────────────────────────────────
# 🧾 COMMANDE : !commandes
# 🔧 UTILITÉ : Affiche dynamiquement toutes les commandes du bot
# 📚 CATÉGORIE : Général (assignée dynamiquement à la fin)
# 🕒 COOLDOWN : 5 secondes par utilisateur
# 🔁 PAGINATION : avec ⬅️ ➡️ (réactions)
# 🧠 TECHNIQUE : Embed Discord + navigation multi-page
# ──────────────────────────────────────────────────────────────
